...
$string['imsenterprise:enrol'] = 'Enroll with IMS';
$string['imsenterprise:manage'] = 'Manage an IMS enrollment';
$string['imsenterprise:unenrol'] = 'Unenroll an IMS instance';
$string['imsenterprise:unenrolself'] = 'Unenroll self in IMS instance';
