...
/**
 * Strings for component 'enrol_imsenterprise2', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    enrol
...
$string['pluginname'] = 'IMS Enterprise file version 2';
...
$string['fromweb'] = "Access via http/https";
...
$string['imsenterprise:config'] = 'Configure imsenterprise instances';
$string['imsenterprise:enrol'] = 'Enrol with IMS';
$string['imsenterprise:manage'] = 'Manage an IMS enrolment';
$string['imsenterprise:unenrol'] = 'Unenrol an IMS instance';
$string['imsenterprise:unenrolself'] = 'Unenrol self in IMS instance. ';$string['location'] = 'File location';
...
$string['unenrolselfconfirm'] = 'Do you really want to unenrol yourself from course "{$a}"? <strong>This will not unenrol you at registration.  Please go to Registration and Records to do that.</strong>';
