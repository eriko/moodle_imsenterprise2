 ...
 * @copyright  Erk Ordway based on work by 2010 Petr Skoda {@link http://skodak.org}
...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'imsenterprise2'), '*', MUST_EXIST);
...
$plugin = enrol_get_plugin('imsenterprise2');
...
$PAGE->set_url('/enrol/imsenterprise2/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_imsenterprise2', format_string($course->fullname));
